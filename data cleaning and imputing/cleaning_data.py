...
df = pd.read_csv("../GSS/2008, 2010, and 2012 results for variables of interest.csv", header=0, index_col=0)

# removing year of survey b/c we don't need that.
df = df.drop('Year of Survey Core', axis = 1)
...
old_and_new_var_names = [
        ...
        ('affirmative_action', 'Affirmative Action African-American Govt Race (Some people say that because of past discrimination, African-Americans should be given preference in hiring and promotion. Others say that such preference in hiring and promotion of African-Americans is wrong because it discriminates against whites. What about your opinion?)', 
            'string'), 
