...
class PlaySession(Base):
    ...
    predicted_income_bucket = Column(Integer, nullable = True)
    income_bucket =         Column(Integer, nullable = True)     
    ...
    predicted_govt_help_black = Column(Integer, nullable = True)
    govt_help_black =       Column(Integer, nullable = True) 
