data_dict= {
	...
	'religious': {
		'title': 'Religiosity', 
		'question': 'To what extent do you consider yourself a religious person? Are you...', 
		'answers': {
			'Not Religious':0, 
	...
	'spiritual': {
		'title': 'Spirituality',
		'question': 'To what extent do you consider yourself a spiritual person? Are you...', 
		'answers': {
			'Not Spiritual':0,
	...
	'party': {
		...
		'question': 'Do you usually think of yourself as a Republican, Democrat, or Independent?', 
		'answers': {
			'Strong Republican':0,
	...
	'court_harsh': {
		...
		'question': 'In general, do you think the courts deal too harshly or not harshly enough with criminals? ', 
		'answers': {
			'Not Harsh Enough':0, 
			'About Right':1, 
			'Too Harsh': 2, 
	...
	'tv': {
		...
		'question': 'On an average day, about how many hours do you personally spend watching television?', 
		'answers': {
			'0': 0,
			'1': 1,
			'2': 2,
	...
	'spanking': {
		...
		'question': 'To what extent do you agree or disagree that it is sometimes necessary to discipline a child with a good, hard spanking?', 
		'answers': {
			'Strongly Disagree':0,
			'Disagree':1,
			'Agree':2,
	...
	'income_distribution': {
		...
		'question': "On a scale from 1 to 7, where 1 indicates that the government ought to reduce income inequality, and 7 means that the government should not reduce income inequality, how would you rate yourself?", 
		'answers': {
	...
	'standard_of_living': {
		...
		'question': 'Compared to your parents when they were the age you are now, how do you think your own standard of living compares?', 
		'answers': {
			'Much Worse':0, 
			'Somewhat Worse':1, 
			'About the Same':2,
	...
	'birth_control': {
		...
		'question': 'To what extent do you agree or disagree that methods of birth control should be available to teenagers between the ages of 14 and 16 if their parents do not approve?', 
		'answers': {
			'Strongly Disagree':0,
			'Disagree':1,
			'Agree':2,
	...
	'affirmative_action': {
		...
		'question': 'To what extent do you agree or disagree with preferential hiring and promotion for African-Americans?', 
		'answers': {
			"Don't Know":'NaN', 
